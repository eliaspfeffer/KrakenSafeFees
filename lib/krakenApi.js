 ...
 */
export async function buyBitcoin(apiKey, apiSecret, amount) {
  try {
    ...
    // Aktuellen Bitcoin-Preis abrufen, um das Volumen zu berechnen
    const tickerResponse = await fetch(
      "https://api.kraken.com/0/public/Ticker?pair=XBTEUR"
    );
    ...
    const estimatedFee = amount * 0.005;
    ...
    console.log(`Bitcoin-Kauf: ${volume} BTC zum Preis von ca. ${btcPrice} EUR/BTC`);
