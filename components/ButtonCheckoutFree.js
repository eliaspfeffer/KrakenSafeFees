...
// This component is now modified to redirect to the login page instead of Stripe checkout
// It keeps the same appearance but changes the functionality
const ButtonCheckout = ({ priceId, mode = "payment" }) => {
  ...
  const handleLogin = async () => {
    ...
    try {
      // Redirect to the login URL from config
